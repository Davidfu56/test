...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to="static/%Y/%m", default="image/123.png",
...
class SysVariables(AbstractUser):
    '''
    系统参数码表
    '''
    name =  models.CharField(max_length=50, blank=True, null=True, verbose_name="系统参数名称")
    key = models.CharField(max_length=50, blank=True, null=True, verbose_name="参数key")
    code =  models.CharField(max_length=50, blank=True, null=True, verbose_name="单个参数值")
    desc = models.CharField(max_length=50, blank=True, null=True, verbose_name="参数值描述")
